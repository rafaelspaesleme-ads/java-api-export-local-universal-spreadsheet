...
public class OptionsSpreadSheetService {
    ...
    public static void exportSpreadSheet(List<String> stringHeaderList, List<List<String>> stringContentList, String dirName, String fileName, String titleTag, String typeContent) throws IOException {
        switch (typeContent) {
            case "application/vnd.ms-excel":
                XlsService.exportExcel(stringHeaderList, stringContentList, dirName, fileName, titleTag);
                break;
            case "application/vnd.oasis.opendocument.spreadsheet":
                OdsService.exportExcel(stringHeaderList, stringContentList, dirName, fileName, titleTag);
                break;
